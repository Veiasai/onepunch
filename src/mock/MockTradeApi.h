...
class MockTraderApi final : public CThostFtdcTraderApi
{
private:
...
public:
	void setInstrumentIDs(char **instruments, int num) { this->instrumentIDs = instruments; this->instrumentNum = num; }
	...
	void RegisterFront(char *pszFrontAddress) { strcpy(this->FrontAddr, pszFrontAddress); }
