...
#include "../Timer.h"
#include "../Strategy.h"
#include "MockTradeSpi.h"

namespace sail { namespace onepunch { namespace mock {

void MockTradeSpi::OnFrontConnected()
{
...
void MockTradeSpi::OnRspAuthenticate(CThostFtdcRspAuthenticateField *pRspAuthenticateField, 
...
void MockTradeSpi::OnRspUserLogin(
...
void MockTradeSpi::OnRspError(CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
	isErrorRspInfo(pRspInfo);
}

void MockTradeSpi::OnFrontDisconnected(int nReason)
{
	std::cerr << "=====网络连接断开=====" << std::endl;
	std::cerr << "错误码： " << nReason << std::endl;
}

void MockTradeSpi::OnHeartBeatWarning(int nTimeLapse)
{
	std::cerr << "=====网络心跳超时=====" << std::endl;
	std::cerr << "距上次连接时间： " << nTimeLapse << std::endl;
}

void MockTradeSpi::OnRspUserLogout(
...
void MockTradeSpi::OnRspSettlementInfoConfirm(
...
void MockTradeSpi::OnRspQryInstrument(
...
void MockTradeSpi::OnRspQryTradingAccount(
...
void MockTradeSpi::OnRspQryInvestorPosition(
...
void MockTradeSpi::OnRspOrderInsert(
...
void MockTradeSpi::OnRspOrderAction(
...
void MockTradeSpi::OnRtnOrder(CThostFtdcOrderField *pOrder)
{
	char str[10];
...
void MockTradeSpi::OnRtnTrade(CThostFtdcTradeField *pTrade)
{
...
bool MockTradeSpi::isErrorRspInfo(CThostFtdcRspInfoField *pRspInfo)
{
...
void MockTradeSpi::reqUserLogin()
{
	static int requestID = 0; // 请求编号
	// changePwd();
...
void MockTradeSpi::reqUserLogout()
{
...
void MockTradeSpi::reqSettlementInfoConfirm()
{
...
void MockTradeSpi::reqQueryInstrument()
{
...
void MockTradeSpi::reqQueryTradingAccount()
{
...
void MockTradeSpi::reqQueryInvestorPosition()
{
...
void MockTradeSpi::reqOrderInsert(
...
void MockTradeSpi::reqOrderAction(CThostFtdcOrderField *pOrder)
{
...
bool MockTradeSpi::isMyOrder(CThostFtdcOrderField *pOrder)
{
...
bool MockTradeSpi::isTradingOrder(CThostFtdcOrderField *pOrder)
{
