...
class MockTradeSpi : public CThostFtdcTraderSpi
{
// ---- ctp_api部分回调接口 ---- //
public:
...
public:
	...
	MockTradeSpi(std::unordered_map<std::string, TickToKlineHelper> & g_KlineHash,
	...
	void setTradeUserApi(MockTraderApi * g_pTradeUserApi) {this->g_pTradeUserApi = g_pTradeUserApi;};
private:
	char* gBrokerID;         // 模拟经纪商代码
	char* gInvesterID;     // 投资者账户名
	char* gInvesterPassword; // 投资者密码
